...
public class PTAnnotationXalanImplementationAnnotated extends main.AbstractXalanImplementation {
    ...
    public PTAnnotationXalanImplementationAnnotated(int type, int nThreads, int repeatFactor) {
        pTAnnotation.PTAnnotationXalanImplementationAnnotated.this.numOfThreads = nThreads;
        pTAnnotation.PTAnnotationXalanImplementationAnnotated.this.repeatFactor = repeatFactor;
        futureGroup = new java.lang.Void[pTAnnotation.PTAnnotationXalanImplementationAnnotated.this.repeatFactor];
    ...
    public void transform() {
        ...
        try {
            pt.runtime.TaskInfoOneArg<java.lang.Void, pu.pi.ParIterator<java.lang.String>> __multiTaskPtTask__ = ((pt.runtime.TaskInfoOneArg<java.lang.Void, pu.pi.ParIterator<java.lang.String>>) (pt.runtime.ParaTask.asTask(pt.runtime.ParaTask.TaskType.MULTI, ((pt.functionalInterfaces.FunctorOneArgNoReturn<pu.pi.ParIterator<java.lang.String>>) (( __parallelIteratorPtNonLambdaArg__) -> multiTransformTask(__parallelIteratorPtNonLambdaArg__))))));
