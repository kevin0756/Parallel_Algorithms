...
public class Main {
    ...
    public static void main(java.lang.String[] args) throws java.io.IOException {
        ...
        while (main.Main.repeat) {
            java.lang.System.out.println("***************** RUNNING Xalan BENCHMARK *****************");
            java.lang.System.out.println("1. ExecutorServices");
            java.lang.System.out.println("2. ParallelTask");
            java.lang.System.out.println("3. Sequential");
            ...
            try {
                ...
                java.lang.String numOfThreasd = "1";
    ...
    public static int paraTaskSchdulingPolicy() {
        ...
        while (true) {
            ...
            java.lang.System.out.print("Enter the schduling policy number (e.g., 1): ");
    ...
    public static void runBenchmark(java.lang.String approach, int numOfThreads) {
        main.XalanBenchRunner xalanBench = null;
        int repeatFactor = -1;
        main.Main.repeat = false;
        switch (approach) {
            case "1" :
                xalanBench = new main.XalanBenchRunner(new executorService.ExecutorMultiXalanImplementation(main.Main.executorType(), numOfThreads));
                break;
            case "2" :
                int schedulingPolicy = main.Main.paraTaskSchdulingPolicy();
                repeatFactor = main.Main.benchmarkRepeatRate();
                xalanBench = new main.XalanBenchRunner(new pTAnnotation.PTAnnotationXalanImplementation(schedulingPolicy, numOfThreads, repeatFactor));
                break;
            case "3" :
                repeatFactor = main.Main.benchmarkRepeatRate();
                xalanBench = new main.XalanBenchRunner(new sequential.SequentialXalanImplementation(repeatFactor));
                break;
            default :
