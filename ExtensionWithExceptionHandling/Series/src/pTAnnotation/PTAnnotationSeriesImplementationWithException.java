...
public class PTAnnotationSeriesImplementationWithException extends main.AbstractSeriesImplementation {
    int numOfThreads;

    public PTAnnotationSeriesImplementationWithException(int type, int numOfThreads) {
        ...
        pTAnnotation.PTAnnotationSeriesImplementationWithException.this.numOfThreads = numOfThreads;
    ...
    public void calculateFourierSeries(double omega) {
        try {
            pu.loopScheduler.LoopScheduler scheduler = pu.loopScheduler.LoopSchedulerFactory.createLoopScheduler(1, array_rows, 1, 
            		numOfThreads, pu.loopScheduler.AbstractLoopScheduler.LoopCondition.LessThan, pu.loopScheduler.LoopSchedulerFactory.LoopSchedulingType.Static);
            pt.runtime.TaskInfoTwoArgs<java.lang.Void, pu.loopScheduler.LoopScheduler, java.lang.Double> __multiTaskPtTask__ = 
            		((pt.runtime.TaskInfoTwoArgs<java.lang.Void, pu.loopScheduler.LoopScheduler, java.lang.Double>) 
            				(pt.runtime.ParaTask.asTask(pt.runtime.ParaTask.TaskType.MULTI, 
            						((pt.functionalInterfaces.FunctorTwoArgsNoReturn<pu.loopScheduler.LoopScheduler, java.lang.Double>)
            								(( __schedulerPtNonLambdaArg__, __omegaPtNonLambdaArg__) -> multiFourierCalc(__schedulerPtNonLambdaArg__, __omegaPtNonLambdaArg__))))));
    ...
    public java.lang.Void multiFourierCalc(pu.loopScheduler.LoopScheduler scheduler, double omega) {
        ...
        if (range != null) {
            for (int i = range.loopStart; i < (range.loopEnd); i++) {
                try {
                    main.AbstractSeriesImplementation.TestArray[0][i] = 
                    		main.AbstractSeriesImplementation.TrapezoidIntegrate(((double) (0.0)), ((double) (2.0)), 1000, (omega * ((double) (i))), 1);
                    main.AbstractSeriesImplementation.TestArray[1][i] = 
                    		main.AbstractSeriesImplementation.TrapezoidIntegrate(((double) (0.0)), ((double) (2.0)), 1000, (omega * ((double) (i))), 2);
