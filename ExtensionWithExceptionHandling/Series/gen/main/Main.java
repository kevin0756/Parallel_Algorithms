...
public class Main {
    ...
    public static void main(java.lang.String[] args) throws java.io.IOException {
        ...
        while (main.Main.repeat) {
            java.lang.System.out.println("***************** RUNNING Series BENCHMARK *****************");
            java.lang.System.out.println("1. ExecutorService");
            java.lang.System.out.println("2. ParallelTask-WithException");
            java.lang.System.out.println("3. ParallelTask-WithoutException");
    ...
    public static int benchmarkDataSize() {
        ...
        while (true) {
            ...
            java.lang.System.out.println("0. 10,000 array rows");
            java.lang.System.out.println("1. 100,000 array rows");
            java.lang.System.out.println("2. 1000,000 array rows");
    ...
    public static void runBenchmark(java.lang.String approach, int numOfThreads) {
        main.JGFSeriesBench SeriesBench = null;
        main.Main.repeat = false;
        switch (approach) {
            case "1" :
                SeriesBench = new main.JGFSeriesBench(new executorService.ExecutorMultiSeriesImplementation(main.Main.executorType(), numOfThreads));
                break;
            case "2" :
                SeriesBench = new main.JGFSeriesBench(new pTAnnotation.PTAnnotationSeriesImplementationWithException(main.Main.paraTaskSchdulingPolicy(), numOfThreads));
                break;
            case "3" :
                SeriesBench = new main.JGFSeriesBench(new pTAnnotation.PTAnnotationSeriesImplementationWithoutException(main.Main.paraTaskSchdulingPolicy(), numOfThreads));
                break;
            case "4" :
                SeriesBench = new main.JGFSeriesBench(new jomp.JompSeriesImplementation(numOfThreads));
                break;
            default :
        ...
        long runtime;
        if (!(main.Main.repeat)) {
            runtime = SeriesBench.run(main.Main.benchmarkDataSize(), main.Main.benchmarkRepeatRate());
