...
public class PTAnnotationMontecarloImplementationWithoutException extends main.AbstractMontecarloImplementation {
    int numOfThreads;

    public PTAnnotationMontecarloImplementationWithoutException(int type, int nThreads) {
    ...
    protected void runSerial() {
        ...
        pt.runtime.TaskInfoOneArg<java.lang.Long, pu.loopScheduler.LoopScheduler> __multiTaskPtTask__ = ((pt.runtime.TaskInfoOneArg<java.lang.Long, pu.loopScheduler.LoopScheduler>) (pt.runtime.ParaTask.asTask(pt.runtime.ParaTask.TaskType.MULTI, ((pt.functionalInterfaces.FunctorOneArgWithReturn<java.lang.Long, pu.loopScheduler.LoopScheduler>) (( __schedulerPtNonLambdaArg__) -> multiCalculate(__schedulerPtNonLambdaArg__))))));
