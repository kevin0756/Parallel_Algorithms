...
public class PTAnnotationMontecarloImplementationAnnotated extends main.AbstractMontecarloImplementation {
    int numOfThreads;

    public PTAnnotationMontecarloImplementationAnnotated(int type, int nThreads) {
