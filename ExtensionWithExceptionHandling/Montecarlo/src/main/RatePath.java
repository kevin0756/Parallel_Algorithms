 ...
 * @throws FileNotFoundException 
    */
  public RatePath(String filename) throws DemoException, FileNotFoundException {
    set_prompt(prompt);
    set_DEBUG(DEBUG);
 ...
 * @throws FileNotFoundException 
    */
  private void readRatesFile(String filename) throws DemoException, FileNotFoundException {
	  
	java.io.BufferedReader in;
  //  in = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("data/hitData"/*+filename*/)));
	in = new BufferedReader(new FileReader("data"+File.separator+filename));
